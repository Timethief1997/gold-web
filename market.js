...
const UPCOMING_EVENTS = [
  ...
  {
    date: '2026-09-11', leadDays: 12,
    title: '美国8月CPI通胀数据',
    desc: '7月CPI同比3.4%、核心2.5%。天风证券等机构认为8月CPI是9月决策关键变量：若超预期回落，美联储或按兵不动；否则加息概率将进一步上升。',
    impact: 'neutral',
    logic: 'CPI是美联储决策的核心锚，直接影响加息/降息预期：通胀反弹→紧缩预期升温→实际利率上行→利空黄金；通胀回落→宽松预期升温→利多黄金。沃什讲话后市场对通胀数据高度敏感，数据公布前会依据预测与先行指标（油价、二手车等）提前定价，故"预期差"比"绝对值"更影响短期金价。'
  },
  {
